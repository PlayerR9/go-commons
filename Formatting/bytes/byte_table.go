...
// ByteTable is a table of bytes.
type ByteTable struct {
	// table is the table of bytes.
	table [][]rune
}

// String implements the fmt.Stringer interface.
func (rt ByteTable) String() string {
...
func (rt *ByteTable) FromBytes(lines [][]byte) error {
	if rt == nil {
...
func (rt *ByteTable) FromRunes(lines [][]rune) error {
	if rt == nil {
		return gcers.NilReceiver
	}
...
//   - *errors.NilReceiver if the receiver is nil.
func (rt *ByteTable) FromStrings(lines []string) error {
	if rt == nil {
		return gcers.NilReceiver
	}
...
func (rt ByteTable) RightMostEdge() int {
...
func (rt *ByteTable) AlignRightEdge() (int, bool) {
	if rt == nil {
		return 0, false
	}
...
// Returns:
//   - bool: True if the receiver is not nil, false otherwise.
func (rt *ByteTable) PrependTopRow(row []rune) bool {
	if rt == nil {
		return false
	}
...
// Returns:
//   - bool: True if the receiver is not nil, false otherwise.
func (rt *ByteTable) AppendBottomRow(row []rune) bool {
	if rt == nil {
		return false
	}
...
// Returns:
//   - bool: True if the receiver is not nil, false otherwise.
func (rt *ByteTable) PrefixEachRow(prefix []rune) bool {
	if rt == nil {
		return false
	}
...
// Returns:
//   - bool: True if the receiver is not nil, false otherwise.
func (rt *ByteTable) SuffixEachRow(suffix []rune) bool {
	if rt == nil {
		return false
	}
